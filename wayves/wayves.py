...
from animation_rules import TOKEN, PROJECT_DIRECTORY
from animation_rules import kill_token_processes
...
class Show(object):
    ...
    def show_cava(category):
        ...
        try:
            ...
            thread2 = threading.Thread(target=kill_cava, args=(category, proc, proc_stop_event))
